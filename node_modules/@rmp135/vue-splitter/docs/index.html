...
<body>
  <div id="app">
    <section class="hero is-dark">
      ...
      <div class="hero-body has-text-centered">
        <div class="container">
          <h1 class="subtitle">For splitting a Vue in two</h1>
        </div>
      </div>
    </section>
    <section class="section">
      <div class="container">
        <vue-splitter @resize="onResize">
          <template slot="left-pane">
            <section class="section">
              <div class="content">
                ...
                <h3>.splitter-pane</h3>
                <p>The left <i>and</i> right panes.</p>
                <h3>.right-pane</h3>
                <p>The right pane only.</p>
                <h3>.left-pane</h3>
                <p>The left pane only.</p>
                <h3>.splitter</h3>
            ...
            <template slot="right-pane">
              <section class="section">
                ...
                <p v-if="logs.length === 0">Try dragging the bar to generate some events.</p>
  ...
  <script type="text/javascript">
    new Vue({
      ...
      methods: {
        onResize () {
          this.logs.unshift(`${(new moment().format('HH:mm:SSSS'))} - Resize`);
        }
      },
      components:  {
        VueSplitter
