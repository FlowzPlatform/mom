  ...
  <div>
      <div id="drag-2" v-draggable>
          <ul id="menu">
              ...
              <li class="menu-item icon-cogs"><a class="menu-item-back" @click="showRoleAccess" href="#roleAccess"></a></li>
              <li class="menu-item icon-tasks"><a class="menu-item-back" @click="showMainTask" href="#main-container"></a></li>
              <li class="menu-item icon-trash"><a class="menu-item-back" href="#menu" @click="showDeleteTasks"></a></li>
              <li class="menu-item fa fa-plus-square-o"><a class="menu-item-back" href="#menu" @click="createProject"></a></li>
              <li class="menu-item icon-search"><a class="menu-item-back" href="#menu" @click="searchResult"></a></li>
