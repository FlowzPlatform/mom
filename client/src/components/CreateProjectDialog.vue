<template>
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="createProject" aria-hidden="true">
                        ...
                        <div class="NewProjectForm-nameAndTeamRow">
                            <div class="NewProjectFormRowStructure--labelPlacementTop NewProjectFormRowStructure NewProjectForm-name">
                                ...
                                <div class="NewProjectFormRowStructure-contents">
                                    <input type="text" @keyup.esc="close" v-model="projectName" tabindex="0" id="new_project_dialog_content_name_input" class="textInput textInput--large NewProjectForm-nameInput"
                                        value="" name="">
                                </div>
                                <div class="NewProjectFormRowStructure-label">
                            ...
                            <div class="NewProjectFormRowStructure--labelPlacementTop NewProjectFormRowStructure">
                                ...
                                <div class="NewProjectFormRowStructure-contents">
                                    <div class="NewProjectForm-descriptionInput textEditor-container">
                                        ...
                                        <textarea class="quill-container" v-model="description" @keyup.esc="close"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="NewProjectForm-privacyOptions NewProjectForm-privacyOptions--noBorder">
                                <label class="NewProjectForm-privacyOption">
                                    ...
                                    <div class="NewProjectForm-privacyOptionLabel">
                                        <div class="NewProjectForm-privacyOptionText">Public to all</div>
                                    </div>
                                </label>
                                <label class="NewProjectForm-privacyOption">
                                    <div class="NewProjectForm-radioButton">
            ...
            <div class="modal-container" @click.stop>
                <div class="modal-header">
                    ...
                    <span style="float:right;font-size:18px;margin-right:5px">
                        <a class="CloseButton" data-dismiss="modal" aria-label="Close" @click="close">
                ...
                <div class="modal-body scrollable scrollable--vertical NewProjectForm">
                    ...
                    <div class="CreateBlankProjectRow NewProjectForm-buttonRow">
                        <a class="Button Button--medium Button--primary CreateBlankProjectRow-button NewProjectForm-createButton" aria-role="button"
                            @click="savePost">Create Project</a>
                    </div>
                </div>
            </div>
        </div>
